...
import { getOptionsForSelector, handleAffiliatesChange, handleQueryChange } from './helper';
      ...
      <div className="analysis-filters__block">
        <p className="analysis-filters__control control">
          ...
          <input
            ...
            onChange={(event) => handleQueryChange(event, setSearchParams, searchParams)}
            value={query}
          />
        </p>
      </div>
      ...
      <div className="analysis-filters__block">
        <div className="analysis-filters__select">
          <Select
            ...
            onChange={(event) => handleAffiliatesChange(event, setSearchParams, searchParams)}
          />
        </div>
      </div>
