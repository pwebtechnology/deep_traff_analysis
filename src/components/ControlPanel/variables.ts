...
export const METRICS_OPTIONS: Metrics_Options[] = ['FTDs', 'PV', 'Net', 'STD Rate', 'Leads', 'CR', 'NA', 'AnRate', 'UnAssigned Leads', 'Calls per FTD', 'Pool VS Assigned', 'Autologin', 'WD', 'WD Rate', 'UnAssigned Tickets', 'ROMI', 'CPA actual']
