...
import { ArrayProperty, CohortsKeys as CohortData, Date, DateProperty } from "../../types/CohortsKeys";
...
export const handleClearMultiselect: HandleClearMultiselect = (setCohortData, cohortData, setError, arrayProperty) => {
  if (!arrayProperty) {
    return;
  }
...
export const handleArrayChange: HandleStringArrayChange = (event, setCohortData, cohortData, setError, arrayProperty) => {
  if (!arrayProperty) {
    return;
  }
...
export const hanldeDividerChange: HanldeDividerChange = (event, setCohortData, cohortData, setError) => {
...
export const handleDateChange: HandleDateChange = (newValue, dateProperty, setCohortData, cohortData, setError) => {
